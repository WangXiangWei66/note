...
root = Tk()
root.title("网络五子棋——客户端")
imgs = [PhotoImage(file='D:\大学\大二下\Python\五子棋\BlackStone.png'),
        PhotoImage(file='D:\大学\大二下\Python\五子棋\WhiteStone.png')]
turn = 0
Myturn = -1
...
def receiveMessage():  #接受客户发来的消息
    ...
    while True:
        ...
        if not data:
            ...
            print("Server has exited!")
            lbl1['text'] = "Server has exited! 游戏结束！"
        elif a[0] == 'over':
            print("对方获胜!")
...
cv.pack()
lbl1 = Label(root, text = "客户端", bg='silver')
lbl1.pack()
